const app = {
    ...
    questions: [
        ...
        },
        {
            ...
            dimension: "social",
            options: [
                { text: "低头狂刷手机，假装在回重要消息", score: 3 },
                { text: "早…早啊领导！今天天气哈哈哈…（尬住）", score: 4 },
        ...
        },
        {
            ...
            dimension: "emotion",
            options: [
                { text: "评论：这滤镜开得，我妈都认不出", score: 2 },
                { text: "默默点赞，心里翻白眼", score: 4 },
                { text: "私信：宝，你本人比照片好看多了", score: 6 },
                { text: "评论：美美美，然后截图发闺蜜群", score: 3 },
        ...
        },
        {
            ...
            dimension: "emotion",
            options: [
                { text: "连环追问：在吗？在干嘛？为什么不回我？", score: 2 },
                { text: "发朋友圈仅TA可见：有些人，已读不回", score: 3 },
                { text: "算了，删除对话框，假装没发过", score: 4 },
                { text: "发个表情包试探：是不是被绑架了？", score: 5 },
        ...
        },
        {
            ...
            dimension: "rules",
            options: [
                { text: "秒回：好的领导，马上改（然后边哭边改）", score: 3 },
                { text: "已读不回，假装睡着了", score: 4 },
                { text: "回复：收到，明早8点前给您（然后设6点的闹钟）", score: 6 },
                { text: "领导，我电脑坏了，正在去网吧的路上（其实根本没动）", score: 2 },
        ...
        },
        {
            ...
            dimension: "social",
            options: [
                { text: "装作没看到，等24小时再回", score: 4 },
                { text: "直接回：不在，借钱免谈", score: 2 },
                { text: "回：在的，最近怎么样？（先聊感情再谈钱）", score: 6 },
                { text: "回：在，不过最近手头紧，帮不上忙", score: 5 },
                { text: "回：在，需要多少？（然后借完拉黑）", score: 3 }
            ]
        },
        {
            type: "饭局地狱",
            ...
            dimension: "rules",
            options: [
                { text: "受宠若惊，一饮而尽，然后开始语无伦次", score: 3 },
                { text: "领导，我应该敬您，怎么能让您敬我呢（套路）", score: 5 },
                { text: "站起来：领导，这杯我敬您，感谢您栽培", score: 7 },
                { text: "领导，我酒精过敏，以茶代酒吧", score: 2 },
                { text: "微笑着举杯：谢谢领导，我干了", score: 6 }
            ]
        },
        {
            type: "社交面具",
            ...
            dimension: "self",
            options: [
                { text: "微笑面具：永远点头微笑，内心毫无波澜", score: 4 },
                { text: "搞笑面具：我是气氛组，不搞笑会死", score: 6 },
                { text: "透明面具：爱谁谁，老子就这样", score: 2 },
                { text: "变色龙面具：见人说人话，见鬼说鬼话", score: 7 },
                { text: "隐身面具：能躲就躲，躲不了就装死", score: 3 }
            ]
        },
        {
            type: "当代社交",
            ...
            dimension: "self",
            options: [
                { text: "记录生活，以后翻着看", score: 4 },
                { text: "精心策划，人设不能崩", score: 6 },
                { text: "随手一发，发完就忘", score: 3 },
                { text: "为了引起某个人的注意", score: 2 },
        ...
        },
        {
            ...
            options: [
                ...
                { text: "你上次说到哪了？（其实根本没在听）", score: 3 },
                { text: "直接打断：分都分了，说点开心的", score: 2 },
                { text: "找借口溜了：我突然有个会", score: 4 }
            ]
        },
        {
            type: "职场生存",
            ...
            dimension: "emotion",
            options: [
                { text: "当场揭穿：这个方案是我做的", score: 2 },
                { text: "会后找领导不经意提及", score: 6 },
                { text: "忍气吞声，下次自己注意", score: 3 },
                { text: "在群里发：感谢XX帮我完善方案", score: 7 },
                { text: "记在小本本上，秋后算账", score: 4 }
            ]
        },
        {
            type: "社交能量",
            ...
            dimension: "social",
            options: [
                { text: "宅家，手机静音，谁都别找我", score: 2 },
                { text: "和一两个好友吃顿好的", score: 6 },
                { text: "去蹦迪/唱K，释放一周压力", score: 5 },
                { text: "参加 networking，拓展人脉", score: 7 },
                { text: "在家刷剧，但微信秒回", score: 3 }
            ]
        },
        {
            type: "拒绝艺术",
            ...
            dimension: "social",
            options: [
                { text: "直接说：我不想去，太无聊了", score: 2 },
                { text: "那天我有事（其实没事）", score: 4 },
                { text: "我可能晚点去（然后不去）", score: 3 },
                { text: "这个场合我不太适应，下次约饭吧", score: 6 },
                { text: "答应去，全程玩手机", score: 5 }
            ]
        },
        {
            type: "群聊战场",
            ...
            dimension: "rules",
            options: [
                { text: "立即@所有人：这个不对", score: 2 },
                { text: "私聊发通知的人提醒", score: 7 },
                { text: "假装没看到，等别人发现", score: 4 },
                { text: "在群里委婉补充正确信息", score: 6 },
                { text: "截图发闺蜜群吐槽", score: 3 }
            ]
        },
        {
            type: "亲戚问答",
            ...
            dimension: "context",
            options: [
                { text: "如实回答，然后被一顿教育", score: 3 },
                { text: "够花，正在找（万能答案）", score: 5 },
                { text: "阿姨，您儿子/女儿怎么样了？", score: 7 },
                { text: "低头扒饭，假装没听见", score: 2 },
                { text: "提前准备了一套标准话术", score: 4 }
            ]
        },
        {
            type: "情绪管理",
            ...
            dimension: "emotion",
            options: [
                { text: "立刻发朋友圈吐槽（仅同事不可见）", score: 3 },
                { text: "去楼梯间深呼吸，平复心情", score: 5 },
                { text: "找闺蜜/兄弟疯狂输出", score: 4 },
                { text: "直接打开招聘软件", score: 2 },
        ...
        },
        {
            ...
            dimension: "self",
            options: [
                { text: "真诚是必杀技，但容易杀死自己", score: 4 },
                { text: "多个朋友多条路，但路太多会迷路", score: 5 },
                { text: "质量胜于数量，但高质量的太难找", score: 6 },
                { text: "独处也挺好，但偶尔想找人说话", score: 3 },
                { text: "社交是什么？能吃吗？", score: 2 }
            ]
        },
        {
            type: "隐藏题",
            ...
            dimension: "self",
            options: [
                { text: "太无聊了，反正没事干", score: 4 },
                { text: "想看看自己到底有多沙雕", score: 5 },
                { text: "被朋友逼着测的", score: 3 },
    ...
    // 12个等级，分数区间重新设计
    levels: [
        { min: 18, max: 30, emoji: "👻", title: "社交幽灵·人间蒸发", rarity: 2, 
        ...
        { min: 31, max: 40, emoji: "🧟", title: "究极社恐·见光死", rarity: 5, 
        ...
        { min: 41, max: 50, emoji: "🤖", title: "职场丧尸·只会嗯嗯", rarity: 8, 
        ...
        { min: 51, max: 58, emoji: "🙈", title: "自闭儿童·已读乱回", rarity: 10, 
          desc: "你想社交，但每次都搞砸。",
          tagline: "努力过了，真的",
        ...
        { min: 59, max: 66, emoji: "🐒", title: "吗喽·复制粘贴型人格", rarity: 12, 
          desc: "你像只吗喽，别人做什么你学什么，社交话术全靠复制粘贴。",
          tagline: "没有感情，全是技巧",
          anatomy: "你的社交策略是'跟风狗'——别人发什么你发什么，别人说什么你说什么。你的朋友圈文案是抄的，你的表情包是盗的，你的观点是集体的。你没有原创社交能力，但模仿得挺像。遇到没见过的场景，你就僵住，等别人先动，然后复制。你不是在社交，你是在'社交cosplay'。" },
        { min: 67, max: 74, emoji: "✨", title: "精致穷·表面光鲜型", rarity: 15, 
          desc: "你看起来人模人样，实际上社交账户余额不足。",
          tagline: "表面风光，内心慌张",
          anatomy: "你的社交模式就像信用卡——表面额度充足，实际早已透支。每次聚会前都要做心理建设，聚会中疯狂计算'还有多久可以溜'，聚会后复盘自己哪句话说错了。你的朋友圈精心策划，但点赞的人你都记不得是谁。你擅长在饭局上微笑点头，但内心已经神游到外太空。你不是社恐，你是'社懒'——懒得应付，但不得不应付。" },
        { min: 75, max: 82, emoji: "🎭", title: "场面混子·全靠演技", rarity: 18, 
          desc: "你能应付大多数场面，但全靠演技，没有感情。",
          tagline: "人生如戏，全靠演技",
          anatomy: "你是社交场上的'老戏骨'——每个表情都是设计好的，每句话都是排练过的。你能让人如沐春风，但内心毫无波澜；你能记住所有人的喜好，但只是为了'用得着'；你能在酒桌上谈笑风生，但回家后一句话不想说。你不是在交朋友，你是在'交作业'。你的社交能力是真的，但你的社交欲望是假的。" },
        { min: 83, max: 90, emoji: "🔥", title: "社交悍匪·见人说人话", rarity: 14, 
        ...
        { min: 91, max: 98, emoji: "🦊", title: "老狐狸·CPU大师", rarity: 10, 
        ...
        { min: 99, max: 106, emoji: "🧙", title: "社交仙人·已臻化境", rarity: 4, 
        ...
        { min: 107, max: 114, emoji: "👑", title: "社交之神·降维打击", rarity: 1, 
        ...
        { min: 115, max: 126, emoji: "🌌", title: "社交奇点·不可名状", rarity: 0.1, 
          desc: "你的社交能力已经超出了人类的理解范围。",
          tagline: "我即社交，社交即我",
          anatomy: "你已经不是社交能力强不强的问题了——你是社交本身。你不需要说话，一个眼神就能让全场安静；你不需要主动，所有人都会来找你；你不需要维护关系，关系会自动围绕你运转。你的社交状态是'量子态'——同时存在于所有社交场合，又不在任何一个场合。你已经超越了社交，进入了'社交玄学'的领域。" }
    ],
